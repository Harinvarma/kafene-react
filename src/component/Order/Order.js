      ...
      <>
       <Navbar />
        <div>
          ...
          <div className={style.checkbox}>
            <span className={style.inputorder}>
              <input defaultChecked={newitem} type="checkbox" id="vehicle1" value="vehicle1" onChange={handleChange} />
              New
            </span>
            <br />
            <span className={style.inputorder}>
              <input defaultChecked={pack} type="checkbox" id="vehicle2" value="vehicle2" onChange={handleChange} />
              Packed
            </span>
            <br />
            <span className={style.inputorder}>
              <input defaultChecked={intransit} type="checkbox" id="vehicle3" value="vehicle3" onChange={handleChange} />
              InTransit
            </span>
            <br />
            <span className={style.inputorder}>
              <input defaultChecked={deliever} type="checkbox" id="vehicle4" value="vehicle4" onChange={handleChange} />
              Delievered
            </span>
            <br />
          </div>
        ...
        <div className={style.tableData}>
          {orderData && orderData.map((userList, index) => {
              return (
